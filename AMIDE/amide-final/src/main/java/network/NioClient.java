...
//  private final Map<SocketChannel, RspHandler> rspHandlers = Collections.synchronizedMap(new HashMap<SocketChannel, RspHandler>());
//
//  public NioClient(InetAddress hostAddress, int port, List<GameObject> objects) throws IOException {
//    this.hostAddress = hostAddress;
//    this.port = port;
//    this.selector = this.initSelector();
//    this.connect();
//    NioClient.objects = objects;
//  }
//
//  public static byte[] aplanarArray(List<GameObject> objects) {
