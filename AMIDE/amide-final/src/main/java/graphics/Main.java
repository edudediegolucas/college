...
public class Main {
  ...
  private final float[] trans = new float[CAJAS];
  private final int[] change = new int[CAJAS];
  private Texture boxTex = null;
  private Texture spaceTex = null;
  private final TextureLoader texLoader = new TextureLoader();
  private final boolean texFilterLinear = false;
  //private Camera camera;
  private final float[][] posiciones = new float[CAJAS][2]; //posiciones iniciales
  private final float[][] exactas = new float[CAJAS][2];    //posiciones exactas en cada momento
  //Modo de movimiento 8 posibles!!!
  private final int[] x = new int[CAJAS];
  private final int[] y = new int[CAJAS];
  private final int[] z = new int[CAJAS];
  //Camara
...
//    boxTex = texLoader.getTexture("images/Rock.png");
//    spaceTex = texLoader.getTexture("images/space.png");
  }
