...
public class NioServer implements Runnable {
	...
	//Lista de workers
	private ArrayList<EchoWorker> workers;
	...
	private Map<SocketChannel,EchoWorker> mapaWorkers = new HashMap<SocketChannel,EchoWorker>();
