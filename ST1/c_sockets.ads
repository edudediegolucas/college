...
--   SOCK_DGRAM:  constant C.int := 2; -- <linux/socket.h>
   ...
   INADDR_ANY: constant C.unsigned_long := 0; -- <linux/in.h>
...
--   pragma Import (C, SetSockOpt, "setsockopt");
   ...
   function Htonl (Data: in C.unsigned_long) return C.unsigned_long;
   ...
   function Ntohl (Data: in C.unsigned_long) return C.unsigned_long;
   ...
   INADDR_NONE : constant C.unsigned_long := 16#ffffffff#;
